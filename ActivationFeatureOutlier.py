...
dataset1 = FacialImageDataset(root='C:/Users/aashr/OneDrive/Documents/Research Projects/EmoryREU/UTKFace.tar/UTKFace/UTKFace', transform=transform)
dataset2 = FacialImageDataset(root='C:/Users/aashr/OneDrive/Documents/Research Projects/EmoryREU/train', transform=transform)
...
feature_diff = torch.abs(features1.mean(dim=0) - features2.mean(dim=0))

# Calculate the top 20% outliers based on feature difference
num_outliers = int(len(dataset2) * 0.20)
