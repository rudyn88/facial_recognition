...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        init.xavier_uniform_(self.conv1.weight)  # Weight initialization using Xavier uniform
        self.pool = nn.MaxPool2d(2, 2)
        self.conv2 = nn.Conv2d(32, 128, 5)
        init.xavier_uniform_(self.conv2.weight)  # Weight initialization using Xavier uniform
        self.fc1 = nn.Linear(128 * 5 * 5, 120)
        init.xavier_uniform_(self.fc1.weight)  # Weight initialization using Xavier uniform
        self.fc2 = nn.Linear(120, 30)
        init.xavier_uniform_(self.fc2.weight)  # Weight initialization using Xavier uniform
        self.dp = nn.Dropout(0.5)
        self.fc3 = nn.Linear(30, 5)
        init.xavier_uniform_(
            self.fc3.weight)  # Weight initialization using Xavier uniform  # UTKFace dataset has 2 classes: male and female, 5 race classes, a lot of age classes
